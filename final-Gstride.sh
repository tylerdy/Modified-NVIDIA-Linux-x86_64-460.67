...
declare -a progs=("AlexNet" "bilateralFilter" "boxFilter" "CifarNet" "convolutionFFT2D" "convolutionSeparable" "dct8x8" "dwtHaar1D" "dxtc" "fastHOG" "fastWalshTransform" "GRU" "histogram" "HSOpticalFlow" "imageDenoising" "LSTM" "matrixMul" "NV12toBGRandResize" "recursiveGaussian" "ResNet" "scalarProd" "SobelFilter" "SqueezeNet" "stereoDisparity" "vectorAdd")
declare -a execs=("./AN 1" "./bilateralFilter" "./boxFilter" "./CN 1" "./convolutionFFT2D" "./convolutionSeparable" "./dct8x8" "./dwtHaar1D" "./dxtc" "./fastHOG" "./fastWalshTransform" "./GRU 1" "./histogram" "./HSOpticalFlow" "./imageDenoising" "./LSTM 1" "./matrixMul" "./NV12toBGRandResize" "./recursiveGaussian" "./RN 1" "./scalarProd" "./SobelFilter" "./SN 1" "./stereoDisparity" "./vectorAdd")
declare -a etimes=(25 14 8 8 16 8  8 8 8 8 10 8 12 12 8 8 10 8 8 16 8 8 10 8 10)
declare -a sleeps=(5  12 6 6 10 12 6 6 6 6 8  6 8  8  6 6 8  6 6 10 6 6 8  6 8)



samples="$1" 
start=1 #"$2"
res_file="/playpen/leochanj/bench/results/eviction-results-Gstride_$(date +"%H%M%S")"
mkdir $res_file
