...
declare -a progs=("matrixMul" "NV12toBGRandResize" "recursiveGaussian" "ResNet" "scalarProd" "SqueezeNet" "stereoDisparity" "vectorAdd")
declare -a execs=("./matrixMul" "./NV12toBGRandResize" "./recursiveGaussian" "./RN 1" "./scalarProd" "./SN 1" "./stereoDisparity" "./vectorAdd")
declare -a etimes=(10 8 8 16 8 10 8 10)
declare -a sleeps=(8  6 6 10 6 8  6 8)


samples="$1" 
start=1 #"$2"
res_file="/playpen/leochanj/bench/results/eviction-results-AB_$(date +"%H%M%S")"
mkdir $res_file
