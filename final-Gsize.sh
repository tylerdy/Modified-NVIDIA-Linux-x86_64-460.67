...
declare -a progs=("SqueezeNet" "stereoDisparity" "vectorAdd")
declare -a execs=("./SN 1" "./stereoDisparity" "./vectorAdd")
declare -a etimes=(10 8 10)
declare -a sleeps=(8  6 8)



samples="$1" 
start=1 #"$2"
res_file="/playpen/leochanj/bench/results/eviction-results-Gsize_$(date +"%H%M%S")"
mkdir $res_file
