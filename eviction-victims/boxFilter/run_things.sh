export NAME="boxFilter_y"
export TRACE_KERNEL="d_boxfilter_rgba_y"
export TRACE_INSTANCE=1
export APP_NAME="boxFilter"
export GRID_DIM="16 1 1"
...
LD_PRELOAD=../../../NVBitTest/mem_traceV2/mem_traceV2.so ./${APP_NAME} -file=ref_14.ppm > ${NAME}Trace 
