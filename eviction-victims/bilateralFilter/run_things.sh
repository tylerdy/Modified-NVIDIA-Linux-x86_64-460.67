export NAME="bilateralFilter"
export TRACE_KERNEL="d_bilateral_filter"
export TRACE_INSTANCE=1
export APP_NAME="bilateralFilter"
export GRID_DIM="40 30 1"
...
LD_PRELOAD=../../../NVBitTest/mem_traceV2/mem_traceV2.so ./${APP_NAME}  > ${NAME}Trace 
