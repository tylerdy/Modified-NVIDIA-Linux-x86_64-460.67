...
sudo cut -d " " -f 2,3,4,5 ${NAME}SortedFmt | traceReuse -o ${VIRT_BASE} 196 1 1 > ${NAME}Reuse
...
sudo python3 ./warpInfo.py ${NAME}SortedReuse 196 1 1 > ${NAME}WarpInfo 2> ${NAME}MemInfo
