export NAME="fwtBatch2Kernel-1"
export TRACE_KERNEL="fwtBatch2Kernel"
export TRACE_INSTANCE=1
export APP_NAME="fastWalshTransform"
export GRID_DIM="8192 1 1"
...
LD_PRELOAD=../../NVBitTest/mem_traceV2/mem_traceV2.so ./${APP_NAME}  > ${NAME}Trace 2> ${NAME}VirtBase
...
sudo traceFormat < ${NAME}TrimmedTrace > ${NAME}Fmt
# VIRT_BASE=$(cat ${NAME}VirtBase)
