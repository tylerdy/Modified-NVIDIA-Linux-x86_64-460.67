export NAME="scalarProd"
export TRACE_KERNEL="scalarProdGPU"
export TRACE_INSTANCE=1

export APP_NAME="scalarProd"
...
sudo cut -d " " -f 2,3,4,5 ${NAME}SortedFmt | traceReuse -o ${VIRT_BASE} 128 1 1 > ${NAME}Reuse
...
sudo python3 ./warpInfo.py ${NAME}SortedReuse 128 1 1 > ${NAME}WarpInfo 2> ${NAME}MemInfo
