...
# bash naive-evaluation-comp.sh 5 matrixMul/matrixMul matrixMul; bash naive-evaluation-comp.sh 5 scalarProd/scalarProd scalarProd; bash naive-evaluation-comp.sh 5 stereoDisparity/stereoDisparity stereoDisparity
...
#declare -a scens=("--smk-hybrid-comp-warps 16 -r 1 -a 983040 -l -w" "--smk-hybrid-comp-warps 32 -r 1 -a 983040 -l -w" ) 
declare -a scens=("--smk-hybrid-comp-warps 0 -r 1 -a 983040 -l -w") 
#declare -a scens=("-m 8 -r 1" "-m 8 -r 2")
