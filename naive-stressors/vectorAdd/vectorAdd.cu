 ...
 */
__global__ void
vectorAdd(const float *A, const float *B, float *C, int numElements, unsigned long long run_time)
{
    int smid;
...
main(int argc, char **argv)
{
    ...
    int numElements = 27649; // enough for 28 blocks, some of which will be killed
    ...
    vectorAdd<<<blocksPerGrid, threadsPerBlock>>>(d_A, d_B, d_C, numElements, run_time);
