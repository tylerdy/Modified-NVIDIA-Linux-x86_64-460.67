...
__used __section(__versions) = {
	...
	{ 0x37537fb1, "alloc_pages_current" },
	...
	{ 0xcbeed2e0, "nvUvmInterfaceRegisterGpu" },
...
MODULE_INFO(srcversion, "DE3B298D4F5E2D7ED800D74");
